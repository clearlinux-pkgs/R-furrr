...
Version  : 0.3.1
Release  : 36
URL      : https://cran.r-project.org/src/contrib/furrr_0.3.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/furrr_0.3.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660669891
...
/usr/lib64/R/library/furrr/tests/testthat/_snaps/furrr-options.md
